...
<Callout type="info">
  ...
  sign-on before you proceed — see [Single Sign-On](/accounts/oauth).
</Callout>
...
<Callout type="warn">
  ...
  [Accounts & Sign-in](/accounts/overview).
</Callout>
...
See [Single Sign-On](/accounts/oauth) for the full form and variable
reference.
