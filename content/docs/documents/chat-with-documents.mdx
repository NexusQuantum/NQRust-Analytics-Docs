...
With one or more documents selected, ask your question in chat the same way you would [ask about your data](/docs/asking/ask). NQRust Analytics routes document questions to the document index, retrieves the most relevant sections from each selected document in parallel, and writes an answer from those passages. This produces a `DOCUMENT_BASED` answer rather than a SQL query.
...
<Cards>
  <Card title="Managing documents" href="/docs/documents/managing-documents">
    Upload, organize, and track indexing status of your documents.
  </Card>
  <Card title="Asking questions" href="/docs/asking/ask">
