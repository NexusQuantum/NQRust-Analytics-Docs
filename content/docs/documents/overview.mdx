...
<Callout type="info">
Scanned or image-only PDFs are supported through OCR — see [Managing documents](/docs/documents/managing-documents) for details and the one prerequisite (the Tesseract binary, which ships in the container image).
</Callout>
