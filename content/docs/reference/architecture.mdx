...
That separation is what makes the platform inspectable, portable, and dependable. To see how a question moves through these components in practice, read [How it works](/docs/concepts/how-it-works).
